...
var Plugin = /** @class */ (function () {
    ...
    Plugin.prototype.insertBlock = function (block) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.query(blockInsertSql(block))];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.chain.getBlock(block.prevBlock)];
                    case 2:
                        prevBlock = _a.sent();
                        if (!(prevBlock != null)) return [3 /*break*/, 4];
    ...
    Plugin.prototype.isBlockInDb = function (block) {
        return this.db.query(blockExistsSql(block)).then(function (result) {
