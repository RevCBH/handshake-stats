...
var Plugin = /** @class */ (function (_super) {
    ...
    Plugin.prototype.handleNewBlock = function (block, entry) {
        return __awaiter(this, void 0, void 0, function () {
            var previousBlockFound, stats, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 6, , 7]);
                        return [4 /*yield*/, this.db.blockExists(block.prevBlock.toString('hex'))];
                    case 2:
                        previousBlockFound = _a.sent();
                        if (!!previousBlockFound) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.catchUpWithChain()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this.calcBlockStats(block)];
                    case 5:
                        stats = _a.sent();
                        this.db.insertBlockStats(stats);
                        return [3 /*break*/, 7];
