...
var Plugin = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        stats = _a.sent();
                        return [4 /*yield*/, this.db.query(blockInsertSql(block, stats))];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.isBlockInDb(prevBlock)];
                    case 4:
                        if (!(_a.sent())) {
    ...
    Plugin.prototype.isBlockInDb = function (block) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.query(blockExistsSql(block))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.rows[0].exists == true];
                }
            });
        });
    };
    ...
    Plugin.prototype.getIssuance = function (bucketSize) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
