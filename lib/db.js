...
var DbRunner = /** @class */ (function () {
    ...
    DbRunner.prototype.getChainTipHash = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.pool.connect(function (connection) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    result = _a.sent();
                                    if ((result === null || result === void 0 ? void 0 : result.hash) != null) {
    ...
    DbRunner.prototype.connectBlock = function (blockHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setBlockWinning(blockHash, true)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    DbRunner.prototype.disconnectBlock = function (blockHash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setBlockWinning(blockHash, false)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    DbRunner.prototype.setBlockWinning = function (blockHash, isWinning) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.pool.connect(function (connection) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, connection.query(slonik_1.sql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n                UPDATE blocks\n                SET onwinningchain = ", "\n                WHERE hash = ", "\n            "], ["\n                UPDATE blocks\n                SET onwinningchain = ", "\n                WHERE hash = ", "\n            "])), isWinning, blockHash))];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.pool.connect(function (connection) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, connection.maybeOne(slonik_1.sql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n                SELECT * FROM blocks\n                WHERE height = ", "\n            "], ["\n                SELECT * FROM blocks\n                WHERE height = ", "\n            "])), height))];
                                case 1:
                                    maybeStats = _a.sent();
                                    if (maybeStats !== null) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.pool.connect(function (connection) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, connection.maybeOne(slonik_1.sql(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n                SELECT * FROM blocks\n                WHERE hash = ", "\n            "], ["\n                SELECT * FROM blocks\n                WHERE hash = ", "\n            "])), hash))];
                                case 1:
                                    maybeStats = _a.sent();
                                    if (maybeStats !== null) {
                                        return [2 /*return*/, maybeStats];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pool.transaction(function (txConnection) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, txConnection.maybeOne(slonik_1.sql(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n            SELECT numrunning, onwinningchain\n            FROM blocks WHERE height = ", " - 1;\n        "], ["\n            SELECT numrunning, onwinningchain\n            FROM blocks WHERE height = ", " - 1;\n        "])), blockStats.height))];
                                case 1:
                                    lastBlock = _a.sent();
                                    return [4 /*yield*/, txConnection.maybeOne(slonik_1.sql(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n            SELECT numopens FROM blocks WHERE height = ", ";\n        "], ["\n            SELECT numopens FROM blocks WHERE height = ", ";\n        "])), blockStats.height - exports.NUM_BLOCKS_AUCTION_IS_OPEN))];
                                case 2:
                                    expiring = _a.sent();
                                    if (lastBlock != null) {
                                ...
                                case 5:
                                    ...
                                    if (e_1.code === '23505') {
                                        ...
                                        logger.error("error inserting block:", e_1.message);
                                    }
                                    return [3 /*break*/, 6];
...
function timeseries(connection, params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    operation = slonik_1.sql(templateObject_10 || (templateObject_10 = __makeTemplateObject([""], [""])));
                    series = slonik_1.sql(templateObject_11 || (templateObject_11 = __makeTemplateObject([""], [""])));
                    switch (params.series) {
                        case 'issuance':
                            series = slonik_1.sql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["issuance - fees"], ["issuance - fees"])));
                            break;
                        case 'fees':
                            series = slonik_1.sql(templateObject_13 || (templateObject_13 = __makeTemplateObject(["fees"], ["fees"])));
                            break;
                        case 'num-airdrops':
                            series = slonik_1.sql(templateObject_14 || (templateObject_14 = __makeTemplateObject(["numAirdrops"], ["numAirdrops"])));
                            break;
                        case 'airdrops':
                            series = slonik_1.sql(templateObject_15 || (templateObject_15 = __makeTemplateObject(["airdropAmt"], ["airdropAmt"])));
                            break;
                        case 'num-blocks':
                            series = slonik_1.sql(templateObject_16 || (templateObject_16 = __makeTemplateObject(["1"], ["1"])));
                            break;
                        case 'opens':
                            series = slonik_1.sql(templateObject_17 || (templateObject_17 = __makeTemplateObject(["numopens"], ["numopens"])));
                            break;
                        case 'running-auctions':
                            series = slonik_1.sql(templateObject_18 || (templateObject_18 = __makeTemplateObject(["numrunning"], ["numrunning"])));
                            break;
                        default:
                    ...
                    switch (params.operation) {
                        case 'avg':
                            operation = slonik_1.sql(templateObject_19 || (templateObject_19 = __makeTemplateObject(["avg(", ")"], ["avg(", ")"])), series);
                            break;
                        case 'sum':
                            operation = slonik_1.sql(templateObject_20 || (templateObject_20 = __makeTemplateObject(["sum(", ")"], ["sum(", ")"])), series);
                            break;
                        default:
                            throw new Error("Invalid timeseries operation: " + params.operation + " ");
                    }
                    return [4 /*yield*/, connection.query(slonik_1.sql(templateObject_21 || (templateObject_21 = __makeTemplateObject(["\n        SELECT time_bucket(", ", time) AS label, ", " AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "], ["\n        SELECT time_bucket(", ", time) AS label, ", " AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "])), params.bucketSize, operation))];
                case 1:
                    result = _a.sent();
