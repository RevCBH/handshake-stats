...
function getIssuance(connection, bucketSize) {
    return __awaiter(this, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, connection.query(slonik_1.sql(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n        SELECT time_bucket(", ", time) AS label, sum(issuance - fees) AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "], ["\n        SELECT time_bucket(", ", time) AS label, sum(issuance - fees) AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "])), bucketSize))];
                case 1:
                    result = _a.sent();
