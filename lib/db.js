                ...
                case 0:
                    ...
                    switch (params.series) {
                        case 'issuance':
                            ...
                            break;
                        case 'num-airdrops':
                            series = slonik_1.sql(templateObject_10 || (templateObject_10 = __makeTemplateObject(["numAirdrops"], ["numAirdrops"])));
                            break;
                        case 'airdrops':
                            series = slonik_1.sql(templateObject_11 || (templateObject_11 = __makeTemplateObject(["airdropAmt"], ["airdropAmt"])));
                            break;
                        case 'num-blocks':
                            series = slonik_1.sql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["1"], ["1"])));
                            break;
                        case 'opens':
                            series = slonik_1.sql(templateObject_13 || (templateObject_13 = __makeTemplateObject(["numopens"], ["numopens"])));
                            break;
                        case 'running-auctions':
                            series = slonik_1.sql(templateObject_14 || (templateObject_14 = __makeTemplateObject(["numrunning"], ["numrunning"])));
                            break;
                        default:
                    ...
                    switch (params.operation) {
                        case 'avg':
                            operation = slonik_1.sql(templateObject_15 || (templateObject_15 = __makeTemplateObject(["avg(", ")"], ["avg(", ")"])), series);
                            break;
                        case 'sum':
                            operation = slonik_1.sql(templateObject_16 || (templateObject_16 = __makeTemplateObject(["sum(", ")"], ["sum(", ")"])), series);
                            break;
                        default:
                            throw new Error("Invalid timeseries operation: " + params.operation + " ");
                    }
                    return [4 /*yield*/, connection.query(slonik_1.sql(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n        SELECT time_bucket(", ", time) AS label, ", " AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "], ["\n        SELECT time_bucket(", ", time) AS label, ", " AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "])), params.bucketSize, operation))];
                case 1:
                    result = _a.sent();
