...
var DbRunner = /** @class */ (function () {
    function DbRunner(logger) {
        this.logger = logger;
        this.blockQueue = [];
        this.insertExecutor = null;
        this.pool = slonik_1.createPool('postgres://handshake-stats:test123@localhost/postgres');
    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pool.transaction(function (txConnection) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, txConnection.maybeOne(slonik_1.sql(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n            SELECT numrunning FROM blocks WHERE height = ", " - 1;\n        "], ["\n            SELECT numrunning FROM blocks WHERE height = ", " - 1;\n        "])), blockStats.height))];
                                case 1:
                                    lastNumRunning = _a.sent();
                                    return [4 /*yield*/, txConnection.maybeOne(slonik_1.sql(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n            SELECT numopens FROM blocks WHERE height = ", ";\n        "], ["\n            SELECT numopens FROM blocks WHERE height = ", ";\n        "])), blockStats.height - exports.NUM_BLOCKS_AUCTION_IS_OPEN))];
                                case 2:
                                    expiring = _a.sent();
...
function timeseries(connection, params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    operation = slonik_1.sql(templateObject_7 || (templateObject_7 = __makeTemplateObject([""], [""])));
                    series = slonik_1.sql(templateObject_8 || (templateObject_8 = __makeTemplateObject([""], [""])));
                    switch (params.series) {
                        case 'issuance':
                            series = slonik_1.sql(templateObject_9 || (templateObject_9 = __makeTemplateObject(["issuance - fees"], ["issuance - fees"])));
                            break;
                        case 'fees':
                            series = slonik_1.sql(templateObject_10 || (templateObject_10 = __makeTemplateObject(["fees"], ["fees"])));
                            break;
                        case 'num-airdrops':
                            series = slonik_1.sql(templateObject_11 || (templateObject_11 = __makeTemplateObject(["numAirdrops"], ["numAirdrops"])));
                            break;
                        case 'airdrops':
                            series = slonik_1.sql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["airdropAmt"], ["airdropAmt"])));
                            break;
                        case 'num-blocks':
                            series = slonik_1.sql(templateObject_13 || (templateObject_13 = __makeTemplateObject(["1"], ["1"])));
                            break;
                        case 'opens':
                            series = slonik_1.sql(templateObject_14 || (templateObject_14 = __makeTemplateObject(["numopens"], ["numopens"])));
                            break;
                        case 'running-auctions':
                            series = slonik_1.sql(templateObject_15 || (templateObject_15 = __makeTemplateObject(["numrunning"], ["numrunning"])));
                            break;
                        default:
                    ...
                    switch (params.operation) {
                        case 'avg':
                            operation = slonik_1.sql(templateObject_16 || (templateObject_16 = __makeTemplateObject(["avg(", ")"], ["avg(", ")"])), series);
                            break;
                        case 'sum':
                            operation = slonik_1.sql(templateObject_17 || (templateObject_17 = __makeTemplateObject(["sum(", ")"], ["sum(", ")"])), series);
                            break;
                        default:
                            throw new Error("Invalid timeseries operation: " + params.operation + " ");
                    }
                    return [4 /*yield*/, connection.query(slonik_1.sql(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\n        SELECT time_bucket(", ", time) AS label, ", " AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "], ["\n        SELECT time_bucket(", ", time) AS label, ", " AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "])), params.bucketSize, operation))];
                case 1:
                    result = _a.sent();
