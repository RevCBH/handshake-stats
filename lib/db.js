    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                //     }
                // })
                return [4 /*yield*/, pool.transaction(function (txConnection) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 5:
                                    e_1 = _a.sent();
                                    console.log("!!!!! error inserting:", e_1);
                                    return [3 /*break*/, 6];
                ...
                case 0:
                    ...
                    switch (params.series) {
                        ...
                        case 'num-blocks':
                            ...
                            break;
                        case 'opens':
                            series = slonik_1.sql(templateObject_11 || (templateObject_11 = __makeTemplateObject(["opens"], ["opens"])));
                            break;
                        default:
                    ...
                    switch (params.operation) {
                        case 'avg':
                            operation = slonik_1.sql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["avg(", ")"], ["avg(", ")"])), series);
                            break;
                        case 'sum':
                            operation = slonik_1.sql(templateObject_13 || (templateObject_13 = __makeTemplateObject(["sum(", ")"], ["sum(", ")"])), series);
                            break;
                        default:
                            throw new Error("Invalid timeseries operation: " + params.operation + " ");
                    }
                    return [4 /*yield*/, connection.query(slonik_1.sql(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n        SELECT time_bucket(", ", time) AS label, ", " AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "], ["\n        SELECT time_bucket(", ", time) AS label, ", " AS value\n        FROM blocks\n        GROUP BY label\n        ORDER BY label ASC\n    "])), params.bucketSize, operation))];
                case 1:
                    result = _a.sent();
